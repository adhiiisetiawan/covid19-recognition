...
Here's the performance of the model using Covid-19 X-Ray Dataset. We just provide three ConvNeXt model (tiny, small, base) because limited resource. Detail about graphic accuracy and loss can be found on [wandb report](https://wandb.ai/adhiisetiawan/covid19-recognition).
